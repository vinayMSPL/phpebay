...
<TABLE cellpadding="2" border="0">
    ...
    <TR>
		...
		<TD><INPUT type="text" name="itemNo"  size=30></TD>
	     ...
	     <TR>
		<TD>modified itemDescription</TD>
		<TD><INPUT type="text" name="itemDescription" value="Please modify this" size=30></TD>
	</TR>
	    <TR>
		<TD>modified quantities</TD>
		<TD><INPUT type="text" name="quantity" value="1"> (must be 1 for Auctions)</TD>
	</TR>
	<TR>
		<TD colspan="2" align="right"><INPUT type="submit" name="submit" value="Revise Html Description"></TD>
	</TR>
</TABLE>
</FORM>
