...
<TITLE>GetSellerEvents</TITLE>
</HEAD>
<BODY>
<FORM action="ebay_GetSellerEvents.php" method="post">
<TABLE cellpadding="2" border="0">
	...
	<TR>
		...
		<TD colspan="2" align="right"><INPUT type="submit" name="submit" value="GetSellerEvents"></TD>
	</TR>
</TABLE>
</FORM>
...
if(isset($_POST['submit']))
{
	...
	if($errors->length > 0)
	{
		...
		$responseDoc->save('GetSellerEvents.xml');

		//echo   " <meta   http-equiv=refresh   content=0;url=GetSellerEvents.xml> "; 
		//get results nodes
		$responses = $responseDoc->getElementsByTagName("GetSellerEventsResponse");
